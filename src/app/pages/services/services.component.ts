...
import { ArticleAsideLayoutComponent } from '../../core/layout/article-aside-layout/article-aside-layout.component';

@Component({
  selector: 'iafrica-services',
  standalone: true,
  imports: [MatCardModule,ArticleAsideLayoutComponent],
